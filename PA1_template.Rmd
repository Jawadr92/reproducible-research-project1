...
##Second this will read the data into activity data frame and show some summary statistics

####activity <- read.csv("data/activity.csv", stringsAsFactors=FALSE)
####str(activity)
####summary(activity)

##Third we will convert date to POSIXct class using lubridate package and then convert interval to hour:minute format
...
##1. We will calculate the total number of steps taken per day (please ignore the missing values)
...
####s the number of missing values in this dataset is fairly large, we cannot be sure if there is no bias introduced by missing values. Therefore we impute missing values based on average number of steps in particular 5-minutes interval.
